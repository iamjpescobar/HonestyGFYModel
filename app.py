...
with tab1:
    ...
    if stats.empty:
        ...
        # Logic to iterate through batters and calculate S.L.A.M Index
        # (This remains as the heart of your existing logic)
